...
<body class="<?php print $classes; ?>" <?php print $attributes;?>>
  ...
  <script type="text/javascript">
    var _paq = _paq || [];
    _paq.push(["setDomains", ["*.anthrocollections.library.cornell.edu","*.anthrocollections.library.cornell.edu"]]);
  ...
  <noscript><p><img src="//webanalytics.library.cornell.edu/piwik.php?idsite=545" style="border:0;" alt="" /></p></noscript>
  <!-- End Piwik Code -->
</body>
</html>
